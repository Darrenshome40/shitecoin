...
By default, shitecoind will dump mempool on shutdown and
...
class MempoolPersistTest(shitecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent shitecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
