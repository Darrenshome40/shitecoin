...
class TestShell:
    """Wrapper Class for shitecoinTestFramework.

    The TestShell class extends the shitecoinTestFramework
    ...
    class __TestShell(shitecoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by shitecoinTestFramework child class.
            self.num_nodes = 1
