...
class TestshitecoinCli(shitecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `shitecoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and shitecoin-cli getwalletinfo return expected wallet info")
            ...
            # Test shitecoin-cli -generate with -rpcwallet in multiwallet mode.
