...
"""Verify that starting shitecoin with -h works as expected."""

from test_framework.test_framework import shitecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(shitecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shitecoin with -h for help text")
        ...
        self.log.info("Start shitecoin with -version for version information")
        ...
        self.log.info("Start shitecoind with -fakearg to make sure it does not start")
