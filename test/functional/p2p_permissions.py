...
class P2PPermissionsTests(shitecoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].shitecoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].shitecoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
