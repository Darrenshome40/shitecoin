...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the shitecoinTestFramework
    pass


class ExampleTest(shitecoinTestFramework):
    # Each functional test is a subclass of the shitecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        shitecoinTestFramework class so other tests can use it."""
