...
// shitecoin includes.
#include <..\src\script\shitecoinconsensus.h>
...
int main()
{
    std::cout << "shitecoinconsensus version: " << shitecoinconsensus_version() << std::endl;
    ...
    auto op0Result = shitecoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, shitecoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
