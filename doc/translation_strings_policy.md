...
This document provides guidelines for internationalization of the shitecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `shitecoin_en.ts` remains unchanged.
