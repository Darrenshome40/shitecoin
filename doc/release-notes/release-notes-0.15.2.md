shitecoin Core version *0.15.2* is now available from:

  <https://shitecoincore.org/bin/shitecoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in shitecoin-tx (TheBlueMatt)
