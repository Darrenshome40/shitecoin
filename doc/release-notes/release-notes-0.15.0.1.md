shitecoin Core version *0.15.0.1* is now available from:

  <https://shitecoin.org/bin/shitecoin-core-0.15.0.1/>

and

  <https://shitecoincore.org/bin/shitecoin-core-0.15.0.1/>
