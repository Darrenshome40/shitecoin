...
shitecoin Core version 0.19.1 is now available from:

  <https://shitecoincore.org/bin/shitecoin-core-0.19.1/>
...
From shitecoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as shitecoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, shitecoin Core does not yet change appearance when
...
- #17488 fix "shitecoind already running" warnings on macOS (fanquake)
