shitecoin Core version 0.10.4 is now available from:

  <https://shitecoin.org/bin/shitecoin-core-0.10.4/>
...
- #6953 `43c2789` Split shitecoin-tx into its own package
- #6953 `dfe0d4d` Include shitecoin-tx binary on Debian/Ubuntu
