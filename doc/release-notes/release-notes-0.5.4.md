shitecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/shitecoin/files/shitecoin/shitecoin-0.5.4/
...
http://gitorious.org/shitecoin/shitecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix shitecoin-Qt notifications under Growl 1.3.
Increase required age of shitecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxshitecoin properly when installing shitecoin-Qt over it. (Windows)
