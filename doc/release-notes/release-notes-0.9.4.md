shitecoin Core version 0.9.4 is now available from:

  https://shitecoin.org/bin/0.9.4/
...
this update is incompatible with the shitecoin system and could lead to consensus
forks.

shitecoin Core released binaries from https://shitecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~shitecoin/+archive/ubuntu/shitecoin
- A third-party or self-compiled shitecoin Core

upgrade to shitecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
