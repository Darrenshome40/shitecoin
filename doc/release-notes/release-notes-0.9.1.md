shitecoin Core version 0.9.1 is now available from:

  https://shitecoin.org/bin/0.9.1/
...
shitecoind from any pre-0.9.1 version, and have enabled SSL for RPC and
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the shitecoin Core software:
