shitecoin Core version 0.16.1 is now available from:

  <https://shitecoincore.org/bin/shitecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting shitecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure shitecoind processes are cleaned up when tests end (sdaftuar)
