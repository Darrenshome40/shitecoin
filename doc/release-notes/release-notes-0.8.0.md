shitecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/shitecoin/files/shitecoin/shitecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the shitecoin
...
New/changed settings (command-line or shitecoin.conf file)
--------------------------------------------------------
