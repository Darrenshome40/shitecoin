shitecoin Core version 0.13.2 is now available from:

  <https://shitecoin.org/bin/shitecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update shitecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow shitecoin-tx to create v2 transactions (btcdrak)
