#!/bin/sh
# Copyright (c) 2017-2019 The shitecoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the shitecoin repository."
  exit 1
fi
...
# See https://github.com/shitecoin/shitecoin/issues/16064
...
echo 'When compiling shitecoind, run `./configure` in the following way:'
echo
