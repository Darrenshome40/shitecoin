# Bootstrappable shitecoin Core Builds

This directory contains the files necessary to perform bootstrappable shitecoin
Core builds.
...
- 24GB of free disk space on the partition that the shitecoin Core git repository
  resides in
...
From the top of a clean shitecoin Core repository:
...
To use dongcarl's substitute server for shitecoin Core builds after having
