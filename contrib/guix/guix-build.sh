...
# Deterministically build shitecoin Core
...
INFO: Building commit ${GIT_COMMIT:?not set} for platform triple ${HOST:?not set}:
      ...
      ...from worktree directory: '${PWD}'
          ...bind-mounted in container to: '/shitecoin'
...
EOF
        ...
        #     same exact path (e.g. mapping '/home/satoshi/shitecoin/' to
        #     '/home/satoshi/shitecoin/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/shitecoin
        #
        #                     maps our current working directory to /shitecoin
        ...
        #     container so that we have something to build. '/shitecoin' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                        ...
                                        OUTDIR=/outdir \
                                      bash -c "cd /shitecoin && bash contrib/guix/libexec/build.sh"
    )
