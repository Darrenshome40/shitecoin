...
#ifndef shitecoin_COMPAT_ASSUMPTIONS_H
#define shitecoin_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "shitecoin cannot be compiled without assertions."
#endif
...
#endif // shitecoin_COMPAT_ASSUMPTIONS_H
