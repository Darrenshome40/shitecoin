...
#ifndef shitecoin_WALLET_WALLETUTIL_H
#define shitecoin_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! shitecoin from opening the wallet, thinking it was newly created, and
...
#endif // shitecoin_WALLET_WALLETUTIL_H
