...
#ifndef shitecoin_WALLET_SCRIPTPUBKEYMAN_H
#define shitecoin_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The shitecoin Core wallet was originally a collection of unrelated private
...
#endif // shitecoin_WALLET_SCRIPTPUBKEYMAN_H
