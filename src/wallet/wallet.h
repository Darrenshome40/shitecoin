...
#ifndef shitecoin_WALLET_WALLET_H
#define shitecoin_WALLET_WALLET_H
...
public:
     ...
     * on this shitecoin node, and set to 0 for transactions that were created
...
#endif // shitecoin_WALLET_WALLET_H
