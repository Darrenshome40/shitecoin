...
#ifndef shitecoin_SCRIPT_STANDARD_H
#define shitecoin_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a shitecoin address
 */
...
/**
 * Generate a shitecoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // shitecoin_SCRIPT_STANDARD_H
