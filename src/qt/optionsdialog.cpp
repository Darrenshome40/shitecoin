    ...
    mapper(nullptr)
{
    ...
    ui->shitecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->shitecoinAtStartup);
    ...
    ui->shitecoinAtStartup->setToolTip(ui->shitecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->shitecoinAtStartup->setText(ui->shitecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openshitecoinConfButton->setToolTip(ui->openshitecoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new shitecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->shitecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openshitecoinConfButton_clicked()
{
