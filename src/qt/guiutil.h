...
#ifndef shitecoin_QT_GUIUTIL_H
#define shitecoin_QT_GUIUTIL_H
...
/** Utility functions used by the shitecoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "shitecoin:" URI into recipient object, return true on successful parsing
