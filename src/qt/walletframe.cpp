...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, shitecoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &shitecoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &shitecoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &shitecoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &shitecoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &shitecoinGUI::updateWalletStatus);
    connect(gui, &shitecoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
