    ...
    platformStyle(_platformStyle)
{
    ...
    // normal shitecoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying shitecoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &shitecoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
