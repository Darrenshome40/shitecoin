...
//! Entry point for shitecoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &shitecoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for shitecoinGUI tests.
void AppTests::guiTests(shitecoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &shitecoinGUI::consoleShown, this, &AppTests::consoleTests);
