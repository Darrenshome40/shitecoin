 ...
 */
#ifndef shitecoin_UTIL_SYSTEM_H
#define shitecoin_UTIL_SYSTEM_H
...
extern const char * const shitecoin_CONF_FILENAME;
extern const char * const shitecoin_SETTINGS_FILENAME;
