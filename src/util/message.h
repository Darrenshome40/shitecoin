...
#ifndef shitecoin_UTIL_MESSAGE_H
#define shitecoin_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's shitecoin address, it must refer to a public key.
...
#endif // shitecoin_UTIL_MESSAGE_H
