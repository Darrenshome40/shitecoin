...
#ifndef shitecoin_INTERFACES_NODE_H
#define shitecoin_INTERFACES_NODE_H
...
//! Top-level interface for a shitecoin node (shitecoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // shitecoin_INTERFACES_NODE_H
