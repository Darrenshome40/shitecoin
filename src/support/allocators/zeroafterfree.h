...
#ifndef shitecoin_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define shitecoin_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // shitecoin_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
