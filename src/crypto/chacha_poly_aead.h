...
#ifndef shitecoin_CRYPTO_CHACHA_POLY_AEAD_H
#define shitecoin_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@shitecoin.
 *
 ...
 *
 * The chacha20-poly1305@shitecoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@shitecoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@shitecoin are relatively fast in
...
#endif // shitecoin_CRYPTO_CHACHA_POLY_AEAD_H
