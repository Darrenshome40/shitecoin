...
#ifndef shitecoin_TEST_SCRIPTNUM10_H
#define shitecoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from shitecoin Core 0.10.0, for cross-comparison.
 */
public:
