 ...
 * for both shitecoind and shitecoin-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/shitecoin/bips/blob/master/bip-0014.mediawiki)
 */
