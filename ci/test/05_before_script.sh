...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/shitecoin
else
  DOCKER_EXEC echo \> \$HOME/.shitecoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/shitecoin/shitecoin/pull/18288#discussion_r433189350 for
  # details.
